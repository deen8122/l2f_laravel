...
<html lang="en">
	...
	<div class="app-conatiner" style="z-index: 1">
		...
		<a href="#mypanel" id="top-menu" class="ui-link ui-btn-left ui-btn ui-shadow ui-corner-all" data-role="button" role="button">
		    <span class="icon2 icon-menu"></span></a>
